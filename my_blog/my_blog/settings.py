...
SECRET_KEY = 'django-insecure--)m0w!3x+4*x#d!g)do7y5%4xl32xchmyy*j=#@*d$p@w22=pz'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / "templates"  # подключили шаблоны
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'registration.context_processors.users',  # добавили контекстный процессор
            ],
        },
    },
]
...
# используемой "боевым" веб-сервером
# после выполнения команды "python manage.py collectstatic"
