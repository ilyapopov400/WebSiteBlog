...
urlpatterns = [
    ...
    path('post_create/<int:pk>/', views.PostCreate.as_view(), name="posts_create"),  # создать новый пост
    ...
    path('post_delete/<int:pk>', views.PostDelete.as_view(), name="post_delete"),  # удаление поста
